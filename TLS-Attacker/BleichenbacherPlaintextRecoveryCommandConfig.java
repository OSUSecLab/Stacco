 ...
 */
public class BleichenbacherPlaintextRecoveryCommandConfig extends ClientCommandConfig {

    public static final String ATTACK_COMMAND = "bleichenbacher_atk";
 ...
 //    }
    ...
    // @Parameter(names = "-errortype", description = "Which error number to insert")
    // Integer error;

    public BleichenbacherPlaintextRecoveryCommandConfig() {
