...
import de.rub.nds.tlsattacker.attacks.impl.BleichenbacherPlaintextRecovery;
...
import de.rub.nds.tlsattacker.attacks.impl.PacketGenerationAttack;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BleichenbacherPlaintextRecoveryCommandConfig bleichenbacherAtk = new BleichenbacherPlaintextRecoveryCommandConfig();
        jc.addCommand(BleichenbacherPlaintextRecoveryCommandConfig.ATTACK_COMMAND, bleichenbacherAtk);
        ...
        PacketGenerationCommandConfig packetGeneration = new PacketGenerationCommandConfig();
        jc.addCommand(PacketGenerationCommandConfig.ATTACK_COMMAND, packetGeneration);
        ...
        switch (jc.getParsedCommand()) {
            ...
            case BleichenbacherCommandConfig.ATTACK_COMMAND:
                ...
                break;
            case BleichenbacherPlaintextRecoveryCommandConfig.ATTACK_COMMAND:
                attacker = new BleichenbacherPlaintextRecovery(bleichenbacherAtk);
                break;
            ...
            case Lucky13CommandConfig.ATTACK_COMMAND:
                ...
                break;
            case PacketGenerationCommandConfig.ATTACK_COMMAND:
                attacker = new PacketGenerationAttack(packetGeneration);
                break;
